...
\vspace{-5mm}
To obtain optimality of $\alg$, we need additional technical assumptions about the $\lambda_{\vk_i}$ and $n_j$:
\begin{itemize}
\vspace{-5mm}
...
\[	j^\ddagger =\max \left \{j \in \naturals : b^{j+1} \Lambda_{j+1} \le \frac{2 a \alpha \alert{\varepsilon}}{\alert{R}(a-1)(1-b^\rho)^{\frac{1}{\rho}}}  \left[1+ \left(\frac{1}{S_2}-1\right)S_1^\rho 
			\right]^{\frac{1}{\rho}} \right\}. \]
There exists some $\omega$  such that\footfullcite{DinEtal20a}\vspace{-2mm}
